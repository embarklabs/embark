...
Deploy.prototype.generate_info_file = function() {
  ...
  for(className in this.contractDB) {
    contracts[className] = {
      abi:this.contractDB[className].compiled.info.abiDefinition
      ,address:this.deployedContracts[className]
      ,code:'0x'+this.contractDB[className].compiled.code
      ,runtimeBytecode:'0x'+this.contractDB[className].compiled.runtimeBytecode
    }
  }
