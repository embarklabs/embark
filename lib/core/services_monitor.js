...
inversify.decorate(inversify.injectable(), ServicesMonitor);
inversify.decorate(inversify.inject(Events), ServicesMonitor, 0);
inversify.decorate(inversify.inject(Logger), ServicesMonitor, 1);
