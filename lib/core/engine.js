...
class Engine {
  ...
  web3Service(options) {
    ...
    async.waterfall([
      ...
      function checkWeb3(next) {
        self.checkWeb3Status(web3Endpoint, (msg) => {
          if (msg === STARTING_BLOCKCHAIN) {
            return; // Do nothing, web3 service will reboot
          }
          next();
        });
      }
      ...
      self.servicesMonitor.addCheck('Ethereum', self.checkWeb3Status.bind(self, web3Endpoint));
