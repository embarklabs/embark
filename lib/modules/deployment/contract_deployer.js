  ...
  deployContract(contract, callback) {
    ...
    async.waterfall([
      ...
      function deployTheContract(next) {
        ...
        NonceManager.getNextNonce(contract.deploymentAccount, (nonceErr, nonce) => {


          console.dir(`=========> deploying contract ${contract.className} with nonce ${nonce} from account ${contract.deploymentAccount}`);
