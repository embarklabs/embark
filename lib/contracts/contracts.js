...
class ContractsManager {
  constructor(logger, plugins, events, config) {
    this.contractFiles = config.contractsFiles;
    this.contractsConfig = config.contractsConfig;
    this.contracts = {};
    this.logger = logger;
    this.plugins = plugins;
    this.contractDependencies = {};
    this.gasLimit = false;//options.gasLimit;
...
inversify.decorate(inversify.injectable(), ContractsManager);
inversify.decorate(inversify.inject(Logger), ContractsManager, 0);
inversify.decorate(inversify.inject(Plugins), ContractsManager, 1);
inversify.decorate(inversify.inject(Events), ContractsManager, 2);
inversify.decorate(inversify.inject(Config), ContractsManager, 3);
inversify.decorate(inversify.inject('gasLimit'), ContractsManager, 4);
